...
\VSTUUnderlinedField{1.5cm}{подпись}{\vphantom{\VSTUHeadOfDepartmentDegreeAndName}}\VSTUUnderlinedField{6.5cm}{инициалы, фамилия}{\VSTUHeadOfDepartmentDegreeAndName}\\
